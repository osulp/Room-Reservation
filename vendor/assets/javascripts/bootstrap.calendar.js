...
;(function ( $, window, document, undefined ) {
    ...
    var pluginName = 'Calendar',
        ...
        template =  ''+
                        '<div class="calendar-caption widget-title">'+
                            '<div class="arrow sel" id="last"><i class="icon-arrow-left icon-white"></i></div>'+
                            '<div class="arrow sel" id="next"><i class="icon-arrow-right icon-white"></i></div>'+
                            '<span class="month"></span> <span class="year"></span>'+
                        '</div>'+
                        '<table class="calendar widget-content" id="calendar">'+
                            '<thead class="calendar-header"></thead>'+
                            '<tbody class="calendar-body"></tbody>'+
                            '<tfoot>'+
                                '<th colspan="7" class="sel" id="current">%msg_today%</th>'+
                            '</tfoot>'+
                        '</table>'+
                    '',
    ...
    Plugin.prototype.click = function (e) {
        e.stopPropagation();
            e.preventDefault();
            var target = $(e.target).closest('td, th, div.sel');
