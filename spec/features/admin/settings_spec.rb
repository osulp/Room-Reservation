...
describe 'settings administration' do
  context 'when logged in as an admin' do
    ...
    %w{max_concurrent_reservations announcement_header_message day_limit from_address from_name cancellation_email reservation_email update_email}.each do |setting|
      describe setting do
