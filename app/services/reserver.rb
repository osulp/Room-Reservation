class Reserver
  ...
  def concurrency_limit
    ...
    return if !reserved_for || !reserver || max_concurrent == 0 || reserver.staff?
  ...
  def authorized_to_reserve
    return if !reserved_for || !reserver || reserver.staff?
  ...
  def duration_correct
    return if !end_time || !start_time || !reserved_for || !reserver || reserver.staff?
  ...
  def reservation_not_in_past
    return if !start_time || !reserver || reserver.staff?
