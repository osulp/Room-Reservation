class Reserver
  module Validations
    ...
    def day_limit_applied
      return if !start_time || day_limit == 0 || !reserver || reserver_ignores_restrictions?
    ...
    def concurrency_limit
      ...
      return if !user || !reserver || !start_time || max_concurrent == 0 || reserver_ignores_restrictions?
    ...
    def authorized_to_reserve
      return if !user || !reserver || reserver_ignores_restrictions? || !user_onid || !reserver_onid
    ...
    def duration_correct
      return if !end_time || !start_time || !user || !reserver || reserver_ignores_restrictions?
