class Canceller
  ...
  def send_email
    ...
    unless reserved_for.email.blank?
      begin
        ReservationMailer.cancellation_email(reservation, reserved_for)
  ...
  def reservation_not_over
    time = reservation.truncated_at if reservation.truncated_at && reservation.truncated_at < reservation.end_time && reservation.truncated_at > reservation.start_time
